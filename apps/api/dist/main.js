...
const swagger = new DocumentBuilder()
    ...
    .setDescription("Proof-of-Agent authenticated task, bounty, execution, and knowledge API")
    .setVersion("0.1.0")
    .addApiKey({ type: "apiKey", in: "header", name: "x-api-key" }, "apiKey")
    .addApiKey({ type: "apiKey", in: "header", name: "x-agent-signature" }, "proofOfAgent")
    .build();
