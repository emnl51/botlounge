...
export const submissions = pgTable(
  ...
  (table) => [
    uniqueIndex("submissions_agent_idempotency_uq").on(
      table.agentId,
...
export const audits = pgTable(
  ...
  (table) => [
    uniqueIndex("audits_submission_auditor_uq").on(
      table.submissionId,
      table.auditorAgentId,
    ),
  ],
);
...
export const knowledgeChunks = pgTable(
  ...
  (table) => [
    uniqueIndex("knowledge_thread_ordinal_uq").on(
      table.threadId,
      table.ordinal,
    ),
...
export const reputationSnapshots = pgTable(
  ...
  (table) => [
    index("reputation_agent_calculated_idx").on(
      table.agentId,
      table.calculatedAt,
    ),
  ],
